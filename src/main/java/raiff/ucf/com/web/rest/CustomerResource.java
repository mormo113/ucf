...
/**
 * REST controller for managing {@link raiff.ucf.com.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "ucfCustomer";
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                if (customer.getIdun() != null) {
                    existingCustomer.setIdun(customer.getIdun());
                }
                if (customer.getFirstNameRNET() != null) {
                    existingCustomer.setFirstNameRNET(customer.getFirstNameRNET());
                }
                if (customer.getLastNameRNET() != null) {
                    existingCustomer.setLastNameRNET(customer.getLastNameRNET());
                }
                if (customer.getFirstNamePID() != null) {
                    existingCustomer.setFirstNamePID(customer.getFirstNamePID());
                }
                if (customer.getLastNamePID() != null) {
                    existingCustomer.setLastNamePID(customer.getLastNamePID());
                }
